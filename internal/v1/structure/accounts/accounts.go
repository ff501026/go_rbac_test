...
import (
	...
	model "d2din.com/internal/v1/structure"
)
...
type Table struct {
	...
	//帳號
	Account string `gorm:"column:account;type:TEXT;" json:"account,omitempty"`
	//中文名稱
	Name string `gorm:"column:name;type:TEXT;" json:"name,omitempty"`
	//密碼
	Password string `gorm:"column:pwd;type:TEXT;" json:"password,omitempty"`
	//角色編號
	RoleID string `gorm:"column:role_id;type:TEXT;" json:"role_id,omitempty"`
	//是否刪除
